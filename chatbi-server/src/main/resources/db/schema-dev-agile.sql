...
CREATE UNIQUE INDEX IF NOT EXISTS uk_agile_project_code ON agile_project(project_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_agile_defect_code ON agile_defect(defect_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_agile_test_case_code ON agile_test_case(case_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_agile_commit_hash ON agile_code_commit(commit_hash);
